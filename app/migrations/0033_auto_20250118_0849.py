...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='race',
            field=models.CharField(blank=True, choices=[('HK', 'Harks'), ('MT', 'Manticarias'), ('FH', 'Foohons'), ('SB', 'Spacebornes'), ('DW', 'Dreamweavers'), ('WK', 'Wookiees'), ('JK', 'Jackos')], default=None, max_length=2, null=True),
        ),
    ]
