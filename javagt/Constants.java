...
public final class Constants {	
	...
	public static final int news_delete_ticks = 288; //two days in 10min server
	...
	public static final HashMap<String, Double> jackos = new HashMap<>();
	public static final HashMap<String, Double> shootout = new HashMap<>();
	...
	harks.put("research_max_military", 250.0);
	...
	spacebournes.put("research_max_energy", 250.0);
	...
	dreamweavers.put("research_max_construction", 250.0);
	...
	wookiees.put("race_special_resource_interest",   0.005);
	wookiees.put("travel_speed",   1.6*2.0);
	wookiees.put("research_max_population", 250.0);
	
	race_info_list.put("WK",wookiees);
	
	jackos.put("pop_growth", 1.0*0.02);
	jackos.put("research_bonus_military",    0.8);
	jackos.put("research_bonus_construction", 0.8);
	jackos.put("research_bonus_tech",         0.8);
	jackos.put("research_bonus_energy",       0.8);
	jackos.put("research_bonus_population",   0.8);
	jackos.put("research_bonus_culture",      0.8);
	jackos.put("research_bonus_operations",   0.8);
	jackos.put("research_bonus_portals",      0.8);
	jackos.put("energy_production",    1.0);
	jackos.put("mineral_production",   0.9);
	jackos.put("crystal_production",   1.0);
	jackos.put("ectrolium_production",   1.0);
	jackos.put("race_special_resource_interest",   0.002);
	jackos.put("travel_speed",   1.0*2.0);
	jackos.put("research_max_culture", 250.0);
	jackos.put("research_max_operations", 250.0);
	jackos.put("race_special_solar_15",   1.1);
	
	race_info_list.put("JK",jackos);
	
	shootout.put("pop_growth", 1.0*0.02);
	shootout.put("travel_speed",   1.0*2.0);
	shootout.put("research_bonus_military",    1.0);
	shootout.put("research_bonus_construction", 1.0);
	shootout.put("research_bonus_tech",         1.0);
	shootout.put("research_bonus_energy",       1.0);
	shootout.put("research_bonus_population",   1.0);
	shootout.put("research_bonus_culture",      1.0);
	shootout.put("research_bonus_operations",   1.0);
	shootout.put("research_bonus_portals",      1.0);
	shootout.put("energy_production",    1.0);
	shootout.put("mineral_production",   1.0);
	shootout.put("crystal_production",   1.0);
	shootout.put("ectrolium_production",   1.0);
	
	race_info_list.put("SO",shootout);
